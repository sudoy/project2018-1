			...
			<div class="row">
				<form class="form-horizontal" action="S0024.html?sale_id=${saleList.saleId}" method="post">
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control" name="saleDate" id="salesDate" placeholder="販売日" value="${HTMLUtils.parseDate(saleList.saleDate)}" readonly>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control text-right"name="unitPrice" id="price"
							 placeholder="単価" value="${saleList.unitPrice}" readonly>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							<input type="text" class="form-control text-right" name="saleNumber" id="count"
							 placeholder="個数" value="${saleList.saleNumber}" readonly>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-2">
							...
							placeholder="小計" value="${HTMLUtils.sumCalc(saleList.unitPrice,saleList.saleNumber)}" readonly>
						</div>
					</div>
